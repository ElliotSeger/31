...
namespace TrettioEtt
{
    ...
    class L33tt4rd2 : Player  //Döp om denna klass till något unikt, max 14 bokstäver, ändra även i main
    {
        //Lägg gärna till egna variabler här

        public L33tt4rd2() //Skriv samma namn här
        {
            Name = "L33tt4rd2"; //Skriv in samma namn här
        }
